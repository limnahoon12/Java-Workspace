...
public class B_ArrayCopy {
	 ...
	 * - 얕은복사 : 배열의 주소값만 복사.
	 * 
	 * - 깊은복사 : 동일한 새로운 배열을 하나 더 만들어서 실제 내부값들을 복사.
	 * 
	 * 
	 * 
	 * 
	...
	public void method2() {
		...
		public void method3() {
			...
			//System.arraycopy(원본 배열명, 원본 배열의 복사를 시작할 인덱스, 복사할 배열명,
			// 복사될 시작 인덱스, 복사할 갯수)
			//System.arraycopy(origin, 0, copy, 0, 5);//1, 2, 3, 4, 5, 0,0,0,0,0
			//System.arraycopy(origin, 0, copy, 2, 5);//0 0 1 2 3 4 5 0 0
			//System.arraycopy(origin, 2, copy, 1, 3);//0 3 4 5 0 0 0 0 0 
		...
		public void method4() {
			 ...
			 * 복사할 것인지 세밀하게 지정가능.
			 * 
			 * 3. Arrays.copyOf apthem : 무조건 원본 배열의 0번 인덱스부터 내가 제시한
			 * 갯수만큼 복사 진행됨. 내가 제시한 길이가 원본배열도 크다면 나머지에는 0의 값으로
			 * 채워서 복사해줌.
			 * 
			 */
		}
		public void method5() {
			...
			int [] copy = origin.clone(); //인덱스 직접 지정 x, 복사할갯수지정 x
			...
			/*
			 * Arrays.toString(배열) 
			 * -> 앞과 뒤에 []각 값다마 ,를 넣어서 하나의 문자열로 연이어서 출력해주는 메서드
			 * 
			 * 
			 */
