...
public class MethodTest1 {
	 ...
	 * 메소드
	 * [표현법]
	 * 접근제한자 예악어(생략가능) 반환할 값의 자료형 메소드명([매개변수]) {
	 * 			수행할 코드;		
	 * 			
	...
	public void method1() {
		...
		System.out.println("매개변수와 반환값이 둘 다 없는 메서드입니다.");
	...
	//4. 매겨변수도 있고, 반환값도 있는 메소드
	public int method4(int a, int b) {
		
		System.out.println("매개변수, 반환값 있습니다.");
