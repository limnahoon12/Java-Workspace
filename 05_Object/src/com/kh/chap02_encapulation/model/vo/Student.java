...
public class Student {
	...
	// 이 떄, 이 메소드는 접근 가능하도록 해야하기때문에 public 접근제한자를 사용
	...
	public void setName(String name) {
		...
		// 왜? 필드명과 매개변수명이 동일한경우 {}영역 내에서는 해당영역에서 만들어진 변수가 좀 더 우선순위가 높기떄문.
		// 객체의 name 접근하려면 this를 사용해야함.
	...
	//모든 필드 값을 하나의 문자열로 합쳐서 돌려주는 용도의 메소드
