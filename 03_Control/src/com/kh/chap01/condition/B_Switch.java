...
public class B_Switch {
	 ...
	 * case 값1 : 실행할 코드1; // 앞으로 동등비교를 할 대상자와 ==값1 일경우 실행할 코드, 
	 * 			break; //실행할 코드 1만 실행하고  switch문을 빠져나갈지 결정하는 키워드.
	 * // 브레이크문이 없다면 아래코드도 계속 실행됨.
	 * case 값2 : 실행할 코드2; 
	 * 			 break;
	 * case 값n : 실핼할 코드n;
	 * 			 break;
	 ...
	 * 					  // 위의 값1, 값2, 값n... 앞으로 동등비교할 대상과 하나도 일치하지 
	 * 					  //않다면,  default내의 실행할 코드가 실행된다.	
	 * 
	 * }
	 * 
	 * switch문 자주사용되지 않지만, 사용하는 경우에는 정말 정밀하게 동일한 연산결과가 수행되어야 하는경우
	 * ex) 키보드 입력, 마우스 입력 등
	 * 
...
//			}
  ...
  public void method2() {
	...
	// int price = 0;
	 ...
	 case "바나나" : System.out.println("바나나는 2000원"); break;
	 case "복숭아" : System.out.println("복숭아는 5000원"); break;
	 default: System.out.println("저희 가게에서 판매하는 과일이 아닙니다.");
	  }
  }
