...
public class D_Printf {
	 ...
	 * System.out.println(출력하고자하는값); => 값 출력만해줌
	 * 
	 * System.out.printf("출력하고자 하는 형식", 출력하고자하는 값, 출력하고자하는값~~);
	 * => f는 format(형식)을 의미
	...
	public void printFtest() {
		...
		// 2. printf를 사용 -> 정수갑의 형식을 %d를 사용해서 완성
		//					 줄바꿈 기능이 없으므로, 직접 개행문자를 추가해줄걸.(\n)
		...
		System.out.printf("%5d \n", iNum1); // %5d : 5칸의 공간 중 오른쪽정렬(숫자는 상관없음)
		System.out.printf("%-5d", iNum1); //%-5d : 5칸의 공간중 왼쪽정렬(음수)
		
		//실수 테스트
		double dNum = 4.27546789;
		System.out.printf("dNum : %f \n", dNum);
		// %f : 소숫점 아래 7번째 줄에서 반올림됭 소숫점 아래 번쨰 까지만 출력됨.
		
		System.out.printf("dNum : %.1f \n", dNum); // dNum : 4.3
		// %.1f : 소숫점 아래 2번쨰 줄에서 반올림되어 소숫점아래 1번쨰 까지만 출력이된다.
		// .자릿수로 제어가능.
		...
		System.out.printf("%C %S \n", ch, str); // %C, %S : 영어 알파벳일 경우 대문자로 변경해서출력 
