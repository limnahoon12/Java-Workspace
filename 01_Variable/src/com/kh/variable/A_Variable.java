...
public class A_Variable {
	...
	public void printVariable() {
		...
		System.out.println("임나훈 : "+(11000 * 4 * 5)+"원입니다.");	
		...
		//변수를 사용하여 월급측정(시급 * 근무시간 * 근무일)
		System.out.println("임나훈 : "+(pay * time * day)+"원 입니다.");
		 ...
		 * 2. 단 한번 값을 기록해두고 필요할때마다 꺼내서 계쏙 사용할 목적으로 사용(재사용)
		 * 3. 유지보수를 쉽게 할 수 있다.
		 */
	}
	// 변수의 선언
	public void declareVariable() {
		...
		// 실수형중 가장 대표적인 자료형 => 보다 정확한 실수값을 담을 수 있기 떄문에.
		...
		sNum = 2;
		iNum = 4;
		lNum = 8L; // long자료형임을 알려주기위해 소문자나 대문자 L을 표기해줌(L을 더 권장해줌)
	...
	public void initVariable() {
		...
		//2-2 실수형
		float fNum = 4.0f; // 4byte;/f단어를 반드시 붙여줘야함.
