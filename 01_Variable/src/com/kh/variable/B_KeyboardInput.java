...
public class B_KeyboardInput {
	...
	public void inputTest1() {
		...
		//				이전까지만 출력해준다.
		//				특히 사용자가 입력한 값에 공백이 포함될 여지가 있는경우 안전하게  nextLine()함수를 사용.
		
		System.out.println("당신의 나이가 몇살입니까? :");
		int age = sc.nextInt();// 사용자가 입력한 값중 정수형 값을 받을 때 사용.
		...
		public void inputTest2() {
			...
			// 실수값을 뽑을떄 =>  sc.nextDouble() / sc.nextFloat()
		...
		/*
		 * 정리
		 * 1. 콘솔 창(모니터)에 출력하기 위헤 : System.out.print[1n]()메소드 이용
		 * 2. 콘솔 창(키보드)로 입력받기 위해 : Scanner를 이용해서 (nextXXX()메소드 이용)
		 * 
		 *  주의사항
		 *  1) sc.nextXXX()메소드 뒤에 sc.nextLine()메소드가 와야할 경우
		 *  sc.nextLine()메소드를 한번 더 실행시켜줘서 버퍼에 남아있는 엔터를 빼줘야한다.
		 *  
		 *  2) '문자' 값을 입력받아야할 경우
